...
def reactor_efficiency(voltage, current, theoretical_max_power):
    ...
    elif eff < 80 and eff >= 60: return 'orange'
    elif eff < 60 and eff >= 30: return 'red'
    else: return 'black'
...
def fail_safe(temperature, neutrons_produced_per_second, threshold):
    ...
    if energy < .9*threshold: return 'LOW'
    elif abs(energy - threshold) <= .1*threshold: return 'NORMAL'
    else: return 'DANGER'
